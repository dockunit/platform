	...
	componentDidMount() {
		...
		jQuery(React.findDOMNode(self.refs.buildImage)).popover({
			...
			content: function() {
				...
				textarea.value = '[![Dockunit Status](https://dockunit.io/svg/' + self.props.repository + '?' + currentBranch + ')](http://dockunit.io/projects/' + self.props.repository + '#' + currentBranch + ')';
